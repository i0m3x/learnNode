...
// This problem is the same as the previous (filtered-ls.js) but introduces the concept  
...
// the directory name, the filename extension string and your callback  
// function, in that order. Don't alter the filename extension string   
